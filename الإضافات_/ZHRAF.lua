...
if NARUTOBOT:get(NARUTO_ID.."skrafa:name" .. msg.chat_id_ .. "" .. msg.sender_user_id_) then   
if text and text:match("^الغاء$") then 
NARUTO_sendMsg(msg.chat_id_, msg.id_, 1, "*💥¦* تم الغاء امر الزخرفه ✔", 1, "md")
NARUTOBOT:del(NARUTO_ID.."skrafa:name" .. msg.chat_id_ .. "" .. msg.sender_user_id_)     
return false
end
if text then
if utf8.len(text) > 20 then
NARUTO_sendMsg(msg.chat_id_, msg.id_, 1,'*📮¦ لا يمكن زخرفة اكثر من 20 حرف *', 1, 'md') 
NARUTOBOT:del(NARUTO_ID.."skrafa:name" .. msg.chat_id_ .. "" .. msg.sender_user_id_)     
return false
end
...
NARUTO_sendMsg(msg.chat_id_, msg.id_, 1, SEND_SKRF,  1, "md")
NARUTOBOT:del(NARUTO_ID.."skrafa:name" .. msg.chat_id_ .. "" .. msg.sender_user_id_)     
end
end
end
...
if NARUTOBOT:get(NARUTO_ID..'lock:skrfa'..msg.chat_id_)  then
taha = '*📮¦ تم تفعيل الزخرفه *\n✓' 
NARUTO_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md") 
NARUTOBOT:del(NARUTO_ID..'lock:skrfa'..msg.chat_id_) 
else
...
if not NARUTOBOT:get(NARUTO_ID..'lock:skrfa'..msg.chat_id_)  then
taha = '*📮¦ تم تعطيل الزخرفه *\n✓' 
NARUTO_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md") 
NARUTOBOT:set(NARUTO_ID..'lock:skrfa'..msg.chat_id_,true) 
else
...
if not NARUTOBOT:get(NARUTO_ID.."lock:skrfa"..msg.chat_id_) then   
NARUTOBOT:setex(NARUTO_ID.."skrafa:name" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 10000, true)   
local t = '*⚡¦* ارسل الاسم الذي تريد زخرفته \n*📬¦* سواء كان بالعربي او بالانكلش 🍁'   
NARUTO_sendMsg(msg.chat_id_, msg.id_, 1,t, 1, 'md') 
else
NARUTO_sendMsg(msg.chat_id_, msg.id_, 1,'*📬¦ الزخرفه معطله *', 1, 'md') 
end
return false
end
