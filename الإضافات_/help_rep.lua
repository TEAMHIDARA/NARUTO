...
if not NARUTOBOT:get(NARUTO_ID..'lock:reoly:bot'..msg.chat_id_) then
...
NARUTO_sendMsg(msg.chat_id_, msg.id_, 1,taha8[math.random(#taha8)], 1, 'html') 
end
...
NARUTO_sendMsg(msg.chat_id_, msg.id_, 1,taha9[math.random(#taha9)], 1, 'html') 
end
...
NARUTO_sendMsg(msg.chat_id_, msg.id_, 1,taha10[math.random(#taha10)], 1, 'html') 
end
...
NARUTO_sendMsg(msg.chat_id_, msg.id_, 1, ''..taha[math.random(#taha)]..'', 1, 'md')
end 
...
'هـايـات يـروحـي┋🌸', 
'يههلا بيك حياتي 💛🌿'}      NARUTO_sendMsg(msg.chat_id_, msg.id_, 1, ''..taha[math.random(#taha)]..'', 1, 'md')   
end
...
'ﯛ୭ﯠ۶ـہٰٰٰٖٖٖلہٰٰٰٖٖٖيکگہٰٰٰٖٖٖمہٰٰٰٖٖٖہ ٵٴلہٰٰٰٖٖٖسہلہٰٰٰٖٖٖاٴمہٰٰٰٖٖٖہ ┆ ➰✌️🏿'}  NARUTO_sendMsg(msg.chat_id_, msg.id_, 1, ''..taha[math.random(#taha)]..'', 1, 'md') 
end 
...
if text =="🌚" then 
taha =   "• فـﮧديت صخـﮧامك🙊👄" 
NARUTO_sendMsg(msg.chat_id_, msg.id_, 1, taha, 1, "html") 
end
if text == "🌚🌚" then 
taha =   "• فـﮧديت صخـﮧامك🙊👄" 
NARUTO_sendMsg(msg.chat_id_, msg.id_, 1, taha, 1, "html") 
...
if text =="شبيكم" then 
taha =   "مبينه شي سلامتك/ ج🎈😌"   NARUTO_sendMsg(msg.chat_id_, msg.id_, 1, taha, 1, "html") 
end
if text =="شبيكك" then 
taha =   "مبينه شي سلامتك/ ج🎈😌" 
NARUTO_sendMsg(msg.chat_id_, msg.id_, 1, taha, 1, "html") 
...
if NARUTOBOT:get(NARUTO_ID..'lock:reoly:bot'..msg.chat_id_) then
taha = '*☑ ※ تم تفعيل ردود البوت *\n✓' 
NARUTO_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md") 
NARUTOBOT:del(NARUTO_ID..'lock:reoly:bot'..msg.chat_id_) 
else
...
NARUTO_sendMsg( msg.chat_id_, msg.id_, 1, taha, 1, "md") 
NARUTOBOT:set(NARUTO_ID..'lock:reoly:bot'..msg.chat_id_,true) 
else
...
NARUTO_sendMsg(msg.chat_id_, msg.id_, 1,delac, 1, 'md')
 end

if MSG_TEXT[1] == 'الاوامر' then
if not is_mod(msg) then 
NARUTO_sendMsg(msg.chat_id_, msg.id_, 1, "*📬 ※ انت لست ضمن الادمنيه 🍃\n📌 ※ يمكنك ارسال { م2 } لعرض قائمة اوامر خاصه في الاعضاء *\n💥", 1, "md")  
return false end
taha = [[
※ source ᴏɴᴇ ɪɴ ɪʀᴀǫ 🔱 »
...
NARUTO_sendMsg(msg.chat_id_, msg.id_, 1, "*📬 ※ انت لست ضمن المدراء 🍃\n📌 ※ يمكنك ارسال { م2 } لعرض قائمة اوامر خاصه في الاعضاء *\n💥", 1, "md")  
return false end
taha = [[
*🙋🏻‍♂※ مرحبا بك عزيزي، 🍃
 ※ في اوامــر المدراء 
...
NARUTO_sendMsg(msg.chat_id_, msg.id_, 1, "*📬 ※ انت لست ضمن المنشئين 🍃\n📌 ※ يمكنك ارسال { م2 } لعرض قائمة اوامر خاصه في الاعضاء *\n💥", 1, "md")  
return false end
taha = [[
*🙋🏻‍♂※ مرحبا بك عزيزي، 🍃
 ※ في اوامــر المنڜئين'
...
NARUTO_sendMsg(msg.chat_id_, msg.id_, 1, "*📬 ※ انت لست ضمن المطورين 🍃\n📌 ※ يمكنك ارسال { م2 } لعرض قائمة اوامر خاصه في الاعضاء *\n💥", 1, "md")  
return false end
taha = [[
*🙋🏻‍♂※ مرحبا بك عزيزي، 🍃
...
NARUTO_sendMsg(msg.chat_id_, msg.id_, 1, "*📬 ※ انت لست المطور الاساسي 🍃\n📌 ※ يمكنك ارسال { م2 } لعرض قائمة اوامر خاصه في الاعضاء *\n💥", 1, "md")  
return false end
taha = [[
*🙋🏻‍♂※ مرحبا بك عزيزي، 🍃
